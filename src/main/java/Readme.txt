...
This is being corrected and a fix will be available soon. 
For now, this tutorial is based on the assumption that Trillo functions 
are written using the default package (i.e. no package name is specified).
