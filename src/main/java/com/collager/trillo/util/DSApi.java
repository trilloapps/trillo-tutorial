...
public class DSApi extends BaseApi {
  ...
  public static DataIterator getDataIterator(String className, String where, String orderBy, int start, int pageSize) {
  ...
  public static DataIterator getDataIterator(String appName, String dsName, int start, int pageSize, String sqlQuery) {
    return new DataIterator(appName, dsName, start, pageSize, sqlQuery);
  }
 
  @SuppressWarnings("deprecation")
  public static DataIterator getDataIterator(int start, int pageSize, String sqlQuery, boolean orderById) {
    return new DataIterator(start, pageSize, sqlQuery, orderById);
  }
  
  @SuppressWarnings("deprecation")
  public static DataIterator getDataIterator(int start, int pageSize, String sqlQuery, String idAttrName, boolean orderById) {
  ...
  public static Object queryBySqlStatement(String dsName, String sqlQuery,
    ...
    return convertToDataResult(remoteCall("DSApi", "queryBySqlStatement", dsName, sqlQuery, params));
  }
